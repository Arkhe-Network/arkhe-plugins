...
mod tests {
    ...
    fn test_hamiltonian_conservation() {
        ...
        let initial_r = 6.371e6 + 100.0e3;
        let initial_theta = PI / 3.0;
        ...
        // Calcular kr para garantir H = 0 (considerando n local)
        let n = tracer.refractive_index(&initial).re;
        initial.kr = n * 10.0e6 / 299792458.0;
